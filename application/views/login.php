...
<body>
	...
	<div id="login">
		...
		<!--<h1>Point Of Sale <?php echo $this->config->item('application_version'); ?></h1>-->		<br/>		<br/>		<center>		<p>Development by <a target='_blank' href='http://www.spadeweb.us'>SPADEWEB</a></p>		</center>
	</div>
</body>
</html>
