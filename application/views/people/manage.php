...
<div id="title_bar" class="btn-toolbar">
	...
	?>		<?php	if ($controller_name == 'rules' or $controller_name == 'Rules')	{	?>		<a class='btn btn-info btn-sm pull-right'  href='<?php echo site_url($controller_name."/view"); ?>'			title='<?php echo $this->lang->line($controller_name. '_new'); ?>'>		<span class="glyphicon glyphicon-user">&nbsp</span><?php echo $this->lang->line($controller_name. '_new'); ?>	</a>			<?php } else { ?>
