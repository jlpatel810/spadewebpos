...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' spadeweb '; ?></title>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>"></a>
				</div>
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<!--<li class="">
							<a onclick='opencal();' href="javascript:void(0);" title="Calculator" class="menu-icon">
								<img src="<?php echo base_url().'images/menubar/cal.png';?>" border="0" alt="Module Icon" /><br />
								Calculator
							</a>
						</li>-->
