					...
					<?php echo form_open($controller_name."/edit_item/$line", array('class'=>'form-horizontal', 'id'=>'cart_'.$line)); ?>
						<tr>
							...
							<td style="align: center;">
								...
								<?php echo form_hidden('item_id_new', $item['item_id']); ?>
							</td>
	...
	<div class="panel-body">
		...
		?>
			<?php echo form_open($controller_name."/select_customer", array('id'=>'select_customer_form', 'class'=>'form-horizontal')); ?>
				<div style="display: none" class="form-group" id="select_customer">
					...
					<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
						<table class="sales_table_100">
							<tr>
								...
								<td>
									<?php echo form_dropdown('payment_type', $payment_options, $selected_payment_type, array('id'=>'payment_types', 'class'=>'selectpicker show-menu-arrow', 'data-style'=>'btn-default btn-sm', 'data-width'=>'auto', 'disabled'=>'disabled','tabindex'=>++$tabindex)); ?>
								</td>
							</tr>
							<tr>
					...
					<?php echo form_open($controller_name."/add_payment", array('id'=>'add_payment_form', 'class'=>'form-horizontal')); ?>
						<table class="sales_table_100">
							<tr>
								<td><?php echo $this->lang->line('sales_payment');?></td>
								<td>
									<?php echo form_dropdown('payment_type', $payment_options,  $selected_payment_type, array('id'=>'payment_types', 'class'=>'selectpicker show-menu-arrow', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit','tabindex'=>++$tabindex)); ?>
								</td>
							</tr>
							<tr>
								<td><span id="amount_tendered_label"><?php echo $this->lang->line('sales_amount_tendered'); ?></span></td>
...
$(document).ready(function()
{
    ...
    $('#add_payment_button').click('click', function(e) {  
	...
	//{
	 ...
	 $("#add_payment_button").keypress(function (e) {
    if (e.keyCode == 13) {
       $('#add_payment_form').submit();
    }
 });
	...
	$("#finish_sale_button").keypress(function(event)
	{
	 ...
	 $("#finish_sale_button").keypress(function (e) {
    if (e.keyCode == 13) {
      $('#buttons_form').attr('action', '<?php echo site_url($controller_name."/complete_receipt"); ?>');
		$('#buttons_form').submit();
    }
